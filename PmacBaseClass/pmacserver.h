...
extern "C"
{
	...
	class FUNCTION_DLL_API IPmacDevice : public COleDispatchDriver
	{
	public:
	...
	/////////////////////////////////////////////////////////////////////////////
	// _IPmacDeviceEvents wrapper class

	class _IPmacDeviceEvents : public COleDispatchDriver
	{
	public:
		_IPmacDeviceEvents() {}		// Calls COleDispatchDriver default constructor
		_IPmacDeviceEvents(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
		_IPmacDeviceEvents(const _IPmacDeviceEvents& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
	...
	public:
		...
		// Operations
	public:
		// method 'Message' not emitted because of invalid return type or parameter type
		// method 'Progress' not emitted because of invalid return type or parameter type
		// method 'Error' not emitted because of invalid return type or parameter type
		// method 'Interrupt' not emitted because of invalid return type or parameter type
		// method 'Unsolicited' not emitted because of invalid return type or parameter type
		// method 'DataReady' not emitted because of invalid return type or parameter type
	};
